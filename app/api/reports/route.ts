...
export async function POST(request: Request) {
  ...
  try {
    ...
    /*
     * The workbook exists only in memory while this request is processed.
     * The original Excel file is never persisted.
     */
    ...
    /*
     * Analyze the workbook directly from memory.
     */
    ...
    /*
     * Save only the analysis result.
     * The original workbook bytes are NOT stored.
     */
